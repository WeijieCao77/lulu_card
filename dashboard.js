    ...
    <div class="wx-side">
      ...
      <div class="row" style="gap:8px;flex-wrap:wrap">
        <select id="gPack">
          ...
          <option value="ame">LCS 包</option>
          <option value="emea">LEC 包</option>
          <option value="lcp">LCP 包</option><option value="cblol">CBLOL 包</option><option value="legend">彩卡包</option>
...
function render(d) {
  ...
  const PACK_CN = { scout: '试训包', elite: '选拔包', ten: '十连包', coach: '教练包', cn: 'LPL 包', pac: 'LCK 包', emea: 'LEC 包', ame: 'LCS 包', lcp: 'LCP 包', cblol: 'CBLOL 包', legend: '彩卡包', duelist: '上单包', initiator: '打野包', controller: '中单包', sentinel: '下路包' }
