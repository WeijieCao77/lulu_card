...
const FACTORS: {
  ...
  { key: 'utility', label: '道具运用', fix: '战术里的「道具」滑杆，以及选手的道具属性；双中单阵容从这一项拿得最多' },
  { key: 'tacticsAtk', label: '战术设置（进攻端）', fix: '这张图的节奏与侵略性滑杆，双决斗阵容往右拉才吃得到' },
  { key: 'tacticsDef', label: '战术设置（防守端）', fix: '节奏与侵略性调高会削弱防守；双下路阵容往左拉才厚' },
  { key: 'style', label: '阵容风格', fix: '双决斗偏攻、双下路偏守、双中单两头都吃。在预案里换一套五个英雄' },
  { key: 'matchup', label: '针对对手', fix: '对双下路放慢节奏，对双决斗别把侵略性拉满，对双中单道具拉高。赛前预案里能看到对手阵容' },
