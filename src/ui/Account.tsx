 ...
 *
 * The id was only ever mintable inside 噜噜卡, which meant somebody who played
        ...
        {id ? (
          <>
            ...
            <p className="tiny faint" style={{ margin: 0, lineHeight: 1.8 }}>
              英雄联盟卡牌和噜噜卡共用这个账号，成就、结局、生涯和卡牌收藏都在上面，换设备时填入即可找回。
              <b>它就是密码，不要发给别人。</b>
            </p>
          ...
          <>
            <p className="small muted" style={{ margin: 0, lineHeight: 1.9 }}>
              不用邮箱和密码，点一下生成一串 ID，<b>同时是噜噜卡的账号</b>，换设备靠它找回。
            </p>
