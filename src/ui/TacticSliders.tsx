...
export const SLIDERS: {
  ...
  { key: 'pace', label: '节奏', lo: '慢速运营', hi: '快速突破', hint: '快节奏进攻更强，防守容易被拉扯。双决斗吃这个，双下路怕这个。' },
  { key: 'utility', label: '道具', lo: '节省', hi: '全开', hint: '道具全开两端都强，道具属性高的五人收益更大；双中单靠它活。' },
      ...
      <div className="row wrap" style={{ gap: 8, alignItems: 'center' }}>
        {map ? (
          own ? (
            ...
            <span className="tiny faint">现在用通用设置，一拖就变成{mapCn(map)}专用</span>
          )
        ) : (
