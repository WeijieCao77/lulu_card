...
export const CHANGELOG: ChangeEntry[] = [{
  date: '2026-09-23', title: '玩家反馈 · 交易与杯赛体验', changes: [
    { kind: '修复', text: '手机上清除已保存卡组前会再次确认；挂牌出售前会核对实际出售的卡牌、等级与价格，减少误触和填错金额。' },
    { kind: '新增', text: '交易所售卡可筛选重复卡，并参考同卡同等级的近期成交价；样本不足时不显示建议价。' },
    { kind: '新增', text: '交易所可关注想收集的选手卡，并直接筛选关注卡的挂牌。' },
    { kind: '新增', text: '阵容页面可以直接强化选手和教练，操作前会显示消耗。' },
    { kind: '调整', text: '知名选手彩卡统一按单个代表赛季制作；Perkz 改为 2019 下路版本，Aphromoo 改为 2018 赛季版本。' },
    { kind: '新增', text: '32 人及以上的全服杯，八强也可获得 50 金币和 1 个试训包；原有冠军、亚军和四强奖励保留。' },
  ],
}, {
  date: '2026-09-23', title: '普通卡分档与其他赛区包调整', changes: [
    { kind: '调整', text: '普通卡调整为81张金卡、196张银卡、400张铜卡。LPL与LCK的金卡比例都低于20%，并保持LCK高于LPL、LPL高于其他；三大区都以铜卡最多、银卡其次、金卡最少。' },
    { kind: '调整', text: '其他赛区包降低金卡与银卡基础概率，改善单张金卡比铜卡更常见的问题，三张至少一银保底保持。试训、选拔、十连、LPL包和LCK包概率不变。' },
    { kind: '调整', text: '受影响普通卡的数值同步调整，电脑对手使用同一套数值。已有卡牌数量、等级、头像不变，40张彩卡与教练卡保持原样。' },
  ],
}, {
  date: '2026-09-23', title: '第三大区更名为其他', changes: [
    { kind: '调整', text: '第三大区统一显示为“其他”，包含 LEC、LCS、LCP、CBLOL，也包含越南等地区队伍。已有赛区包、图鉴进度和默契计算保持一致。' },
  ],
}, {
  date: '2026-09-22', title: '其他赛区默契合并', changes: [
    { kind: '调整', text: '默契统一按 LPL、LCK、其他三大区计算。原 LEC、LCS、LCP、CBLOL 选手之间，以及这些联赛的教练与选手之间，都可触发同赛区默契；同队传承、同国籍的优先级保持不变。' },
  ],
}, {
  date: '2026-09-22', title: '赛区金卡比例校准', changes: [
    { kind: '调整', text: '普通选手金卡占各自赛区卡池的比例调整为 LCK 28.7% > LPL 24.3% > 其他 9.3%。LCK 现有 35 金、30 银、57 铜；卡包出金概率与保底规则不变。' },
  ],
}, {
  date: '2026-09-22', title: '三大区收集', changes: [
    { kind: '调整', text: '游戏赛区归类为 LPL、LCK、其他三大区。其他包含 LEC、LCS、LCP、CBLOL 四个联赛；人物资料仍保留所属的真实联赛。' },
    { kind: '调整', text: '原 LEC、LCS、LCP、CBLOL 四个地区的卡包合并为其他包，原库存合并保留；周选优惠赛区同步改为三大区。' },
